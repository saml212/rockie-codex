...
2. Run `scripts/quote_term_sheet.py` to build the canonical JSON term-sheet object.
   ...
   a heuristic quote.
3. Render the markdown block with `scripts/render_term_sheet.py`. The block must show:
